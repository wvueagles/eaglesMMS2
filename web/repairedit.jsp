...
<html>
    ...
    <body>
        ...
        <div id='repairedit'> 
            <form action="MMSController?action=repairedit" method="POST">
                <strong> Pothole Entry Menu Item</strong>
                <br> <br>
                <p>Enter new repair data:</p>
                <p><label>Work ID:</label> <input type="text" id="workid" name="workid" size="40" value=${workid} readonly ></p>
                <p><label>Status:</label> <select name="status" value=${status}><option value="LOGGED">LOGGED</option><option value="REPAIR">REPAIR</option><option value="FAIL">FAIL</option><option value="PASS">PASS</option></select></p>
